...
int farLeftIR = A4;
int frontNearLeftIR = A2;
int frontCenterIR = A1;
int frontNearRightIR = A0;
int farRightIR = A3;

int backNearLeftIR = A2;   // To Be Changed
int backCenterIR = A1;     // To Be Changed
int backNearRightIR = A0;  // To Be Changed
